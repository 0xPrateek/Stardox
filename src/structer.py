...
\033[1;37m|'''
.format("|",data.name_list[pos],data.username_list[pos],data.repo_list[pos].strip(),data.star_list[pos].strip(),data.followers_list[pos].strip(),data.following_list[pos].strip(),data.email_list[pos].strip()))
